    ...
    <SiteLayout>
      <main id="career-page" className="min-h-screen overflow-hidden bg-white text-black">
        ...
        <section className="relative overflow-hidden bg-white px-5 pb-4 pt-32 sm:px-8 sm:pb-6 sm:pt-40 lg:px-12 lg:pb-8">
          ...
          <div
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-16 h-72 w-72 -translate-x-1/2 rounded-full bg-[#108D82]/5 blur-[110px]"
          />

          <div className="relative mx-auto max-w-[1000px] text-center">

            {/* Badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-[#108D82]/20 bg-white px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[#108D82] shadow-sm">
            ...
            <div className="mt-9 flex flex-wrap justify-center gap-3">
              ...
              <Link
                href="#open-roles"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-[#108D82] px-6 text-sm font-bold text-white shadow-[0_12px_30px_rgba(16, 141, 130,0.2)] transition duration-300 hover:-translate-y-1 hover:bg-[#108D82] hover:shadow-[0_18px_40px_rgba(16, 141, 130,0.25)]"
              >
              ...
              <Link
                href="/about"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white px-6 text-sm font-bold text-black shadow-sm transition duration-300 hover:-translate-y-1 hover:border-[#108D82]/40 hover:text-[#108D82] hover:shadow-md"
              >
                Meet vozon.ai
                <ArrowIcon />
              </Link>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              ...
              {openRoles.map((role, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 top-0 h-0.5 bg-[#108D82] opacity-0 transition duration-300 group-hover:opacity-100" />
                  ...
                  <div className="flex flex-1 flex-col">
                    ...
                    <div className="mt-5 flex flex-wrap gap-2">
                      ...
                      {role.tags.map((tag) => (
                        ...
                        <span
                          key={tag}
                          className="rounded-full border border-gray-200 bg-white px-3 py-1.5 text-[9px] font-medium text-gray-600 transition duration-300 group-hover:border-[#108D82]/20"
                        >
                          {tag}
                        </span>
                    ...
                    <div className="mt-auto pt-7">
                      <a
                        ...
                        className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-3 text-xs font-bold text-black transition duration-300 hover:border-[#108D82] hover:bg-[#108D82] hover:text-white"
                      >
                        Apply now
                        <ArrowIcon />
                      </a>
            ...
            <div className="mt-11 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              ...
              {benefits.map((benefit) => (
                ...
                >
                  ...
                  <div className="grid size-11 place-items-center rounded-xl border border-[#108D82]/15 bg-[#108D82]/5 text-lg text-[#108D82] transition duration-300 group-hover:bg-[#108D82] group-hover:text-white">
                    {benefit.icon}
                  </div>
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  <summary className="flex cursor-pointer list-none items-center gap-5 py-6 text-left [&::-webkit-details-marker]:hidden">
                    ...
                    <span className="ml-auto grid size-8 shrink-0 place-items-center rounded-full border border-gray-300 bg-white text-lg font-light text-black transition duration-300 group-open:rotate-45 group-open:border-[#108D82] group-open:text-[#108D82]">
                      +
                    </span>
