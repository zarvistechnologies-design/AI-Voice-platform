      ...
      <main id="about-page" className="min-h-screen overflow-hidden bg-white text-black">
        ...
        <section className="about-hero relative overflow-hidden px-5 pb-12 pt-24 sm:px-8 sm:pb-14 sm:pt-28 lg:px-10 lg:pb-16 lg:pt-32">
          ...
          <div className="relative mx-auto max-w-[1250px] text-center">
            ...
            {/* Badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-[#3e75ff]/20 bg-white px-4 py-2 shadow-sm">
        ...
        <section className="relative bg-white px-5 py-10 sm:px-8 lg:px-10 lg:py-12">
          ...
          <div className="mx-auto max-w-[1200px]">
            ...
            <div className="mb-5 flex items-center gap-3">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#3e75ff]">
                Our mission
              </span>
            </div>
              ...
              <div className="relative flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
                ...
                <div className="lg:max-w-[540px]">
                  ...
                  <div className="mb-4 flex items-center gap-2">
                    ...
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 bg-white text-[#3e75ff] shadow-sm">
                      <SparkIcon />
                    </div>

                    <span className="text-[9px] font-bold uppercase tracking-[0.18em] text-[#3e75ff]">
                      What we believe
                    </span>
            ...
            <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_0.95fr] lg:items-center lg:gap-16">
              ...
              <div className="group relative min-h-[340px] overflow-hidden rounded-[24px] border border-gray-200 bg-black shadow-[0_18px_50px_rgba(0,0,0,0.08)] sm:min-h-[400px] lg:min-h-[470px]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-7">
                  ...
                  <div className="mb-4 h-px w-16 bg-[#3e75ff]" />
              ...
              <div className="relative flex flex-col justify-between py-3 lg:translate-x-4 lg:py-6 xl:translate-x-6">
                ...
                <div className="relative">
                  ...
                  <div className="mb-5 flex h-10 w-10 items-center justify-center rounded-xl border border-[#3e75ff]/20 bg-white text-[#3e75ff]">
                    <SparkIcon />
                  </div>
                ...
                <div className="relative mt-8 border-l-2 border-[#3e75ff] pl-5 sm:pl-6">

                  <div className="mb-2 text-2xl leading-none text-[#3e75ff]">
                    “
                  </div>
                  ...
                  <div className="mt-5 flex items-center gap-3">
                    ...
                    <div className="h-px w-8 bg-[#3e75ff]" />

                    <span className="text-[9px] font-bold uppercase tracking-[0.16em] text-[#3e75ff]">
                      Built together
                    </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#3e75ff]">
                            {item.label}
                          </p>
