          ...
          <div className="mx-auto max-w-[1040px] space-y-6">
            ...
            >
              ...
              <div className="mt-6 rounded-lg border border-[#E5E5E5] border-l-black bg-white p-5 sm:p-6">
                ...
                <a
                  className="group mt-6 inline-flex min-h-12 items-center gap-4 rounded-lg border border-black bg-white px-5 text-sm font-bold text-black shadow-[0_8px_24px_rgba(0,0,0,0.05)] transition duration-300 hover:-translate-y-0.5 hover:bg-black hover:text-white"
