    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            Monitor reliability, prevent abuse, investigate incidents, and protect the service.
          </li>
          <li>
            Understand product performance and improve features and user experience.
          </li>
          <li>
            Respond to enquiries and send service, security, and administrative communications.
          </li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            Service providers that support hosting, communications, security, analytics, billing,
            and customer support.
          </li>

          <li>
            Integrations and destinations selected or configured by the customer.
          </li>

          <li>
            Professional advisers, regulators, courts, or authorities when required by law or
            necessary to protect rights and safety.
          </li>

          <li>
            A successor or relevant party in connection with a merger, financing, reorganization,
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        where it was collected. Where applicable, we use contractual and other safeguards
        intended to provide an appropriate level of protection for cross-border transfers.
      </p>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          If your information was collected through a voice agent operated by one of our
          customers, contact that organization first. We will support the customer in responding
          to valid requests. For information controlled directly by vozon.ai, contact us using the
          details below. We may verify your identity before completing a request.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <p>
        ...
        platform. If you believe a child has provided personal information to us, please contact
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        We will post the revised policy on this page and update the date shown above. Where
  ...
  return (
    <SiteLayout>
      <div className="min-h-screen overflow-hidden !bg-white text-black">
        ...
        <section className="relative isolate overflow-hidden bg-white px-[clamp(1.25rem,5vw,4.75rem)] pb-20 pt-32 sm:pt-36 lg:pb-24 lg:pt-25">
          ...
          <div className="relative z-10 mx-auto max-w-[1240px]">
            ...
            <div className="mx-auto max-w-[780px] text-center">
              ...
              <span className="mx-auto grid size-16 place-items-center rounded-xl bg-[#EAF7F4] text-[#108D82] shadow-[0_18px_45px_rgba(16,141,130,0.10)]">
                <svg
                  aria-hidden="true"
                  className="size-8"
                  fill="none"
              ...
              <h1 className="mt-7 text-5xl font-semibold leading-none tracking-normal text-black sm:text-6xl">
                Privacy Policy
              </h1>
        ...
        ========================================================== */}
        <section className="bg-white px-[clamp(1.25rem,5vw,4.75rem)] pb-10">
          <div className="mx-auto max-w-[1040px] space-y-5">
            ...
            <div className="flex flex-col gap-5 rounded-lg border border-[#E2E2E2] bg-white p-6 shadow-[0_22px_55px_rgba(0,0,0,0.04)] sm:flex-row sm:items-start sm:p-8">
              {/* Icon — Terms style */}
              <span className="grid size-11 shrink-0 place-items-center rounded-lg bg-[#EAF7F4] text-[#108D82]">
                <svg
                  aria-hidden="true"
                  className="size-5"
                  fill="none"
              ...
              <p className="text-[15px] leading-7 text-black sm:text-base sm:leading-8">
                Welcome to vozon.ai. We are committed to handling personal
                information transparently and responsibly. This Privacy Policy
                explains how we collect, use, protect, and manage information
                when you use our website, AI voice platform, and related
                services.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 rounded-lg border border-[#E2E2E2] bg-white p-6 sm:flex-row sm:items-start">
              {/* Icon — Terms style */}
              <span className="grid size-10 shrink-0 place-items-center rounded-lg bg-[#EAF7F4] text-[#108D82]">
                <svg
                  aria-hidden="true"
                  className="size-5"
                  fill="none"
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-black sm:text-[15px]">
                  When a voice agent is operated by one of our customers, that
                  customer determines why call information is processed and is
                  responsible for required recording or AI notices. Contact
                  that organization first for requests about those
                  conversations.
                </p>
              </div>
            </div>
        ...
        {/* =========================================================
            PRIVACY SECTIONS
        ========================================================== */}
        <section className="bg-white px-[clamp(1.25rem,5vw,4.75rem)] pb-24 pt-4 sm:pb-28">
          <div className="mx-auto max-w-[1040px] space-y-6">
            {privacySections.map((section) => (
              <article
                className="privacy-policy-section scroll-mt-28 rounded-lg border border-[#E2E2E2] bg-white p-5 shadow-[0_22px_60px_rgba(0,0,0,0.035)] sm:p-8"
                id={section.id}
                key={section.id}
              >
                <div className="flex items-center gap-4">
                  {/* Number badge — Terms style (blue) */}
                  <span className="inline-flex size-11 shrink-0 items-center justify-center rounded-lg bg-[#EAF7F4] font-mono text-xs font-bold tracking-normal text-[#0B756C]">
                    {section.number}
                  </span>

                  <h2 className="text-xl font-semibold leading-snug tracking-normal text-black sm:text-3xl">
                    {section.title}
                  </h2>
                </div>

                <div className="privacy-policy-copy mt-6 rounded-lg border border-[#E1E9E7] border-l-[#108D82] bg-white p-5 text-[15px] leading-7 text-black sm:p-6 sm:text-base sm:leading-8">
                  {section.content}
                </div>
              </article>
            ))}
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <span className="inline-flex size-11 shrink-0 items-center justify-center rounded-lg bg-[#EAF7F4] font-mono text-xs font-bold text-[#0B756C]">
                  12
                </span>
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-xl font-semibold tracking-normal text-black sm:text-3xl">
                    Contact us about your information
                  </h2>
                </div>
              </div>

              <div className="mt-6 rounded-lg border border-[#E1E9E7] border-l-[#108D82] bg-white p-5 sm:p-6">
                <p className="max-w-[760px] text-[15px] leading-7 text-black sm:text-base sm:leading-8">
                  ...
                  include passwords, payment card details, or unnecessary
                  sensitive information.
                </p>

                <a
                  className="group mt-6 inline-flex min-h-12 items-center gap-4 rounded-lg border border-[#108D82] bg-[#108D82] px-5 text-sm font-bold text-white shadow-[0_8px_24px_rgba(16,141,130,0.16)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#0B756C]"
            ...
            <p className="px-2 pt-3 text-center text-xs leading-6 text-black">
              ...
              contract between vozon.ai and a customer.
            </p>
          </div>
        </section>
