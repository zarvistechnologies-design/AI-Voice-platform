    ...
    <section className="india-voice-experience" id="india-voice" aria-labelledby="india-voice-title">
      <div className="india-voice-intro">
        ...
        <h2 id="india-voice-title">
          <span className="india-heading-line">Voice AI in every language<span className="india-heading-dot">.</span></span>
        </h2>
        <p>Natural conversations across 140+ languages—with the same workflows, integrations, and human handoffs.</p>
      </div>
      ...
      <style jsx global>{`
        .india-voice-experience{--iv-accent:#45ddce;--iv-bright:#75fff0;position:relative;box-sizing:border-box;width:calc(100% - 2rem);max-width:1560px;margin:1.5rem auto;padding:2rem 1.25rem 1.5rem;overflow:hidden;scroll-margin-top:82px;border:1px solid transparent;border-radius:16px;background:linear-gradient(#000,#000) padding-box,linear-gradient(118deg,rgba(69,221,206,.88),rgba(24,104,202,.45) 35%,rgba(118,48,190,.58) 67%,rgba(236,0,151,.76)) border-box;box-shadow:0 0 0 1px rgba(255,255,255,.025),0 16px 54px rgba(0,0,0,.45),0 0 28px rgba(69,221,206,.06),0 0 40px rgba(190,0,151,.04);color:#fff}
        ...
        .india-voice-experience:after{content:"";position:absolute;inset:0;border-radius:15px;box-shadow:inset 0 1px 0 rgba(255,255,255,.07),inset 0 0 34px rgba(69,221,206,.025);pointer-events:none}
        .india-voice-intro{position:relative;z-index:1;max-width:1000px;margin:0 auto 1rem;text-align:center}.india-voice-intro .india-voice-eyebrow{justify-content:center}
        .india-voice-layout{position:relative;z-index:1;display:grid;grid-template-columns:minmax(300px,1fr) minmax(300px,1fr) minmax(230px,.78fr);align-items:center;gap:1rem}
        ...
        .india-voice-intro h2{margin:.55rem 0 .4rem;font-size:clamp(2.25rem,3.4vw,3.35rem);font-weight:900;line-height:.96;letter-spacing:-.05em}.india-heading-line{display:block;color:#fff;white-space:nowrap}.india-heading-line .india-heading-dot{color:var(--iv-accent)}
        .india-voice-intro>p{max-width:820px;margin:0 auto;color:rgba(255,255,255,.72);font-size:.82rem;line-height:1.45}
        ...
        .india-language-list{display:grid;grid-template-columns:1fr 1fr;gap:.2rem .5rem;margin-top:.5rem}
        .india-language-list button{position:relative;display:grid;min-width:0;grid-template-columns:32px minmax(0,1fr);grid-template-rows:auto auto;align-items:center;column-gap:.5rem;row-gap:.02rem;min-height:38px;padding:.18rem 1.5rem .18rem .2rem;border:1px solid transparent;border-radius:10px;background:transparent;color:#fff;text-align:left;cursor:pointer;transition:.2s}
