...
function formatInr(valueInUsd: number) {
  const value = valueInUsd * 96.5;
          ...
          <article className="pricing-plan-card relative grid overflow-hidden rounded-3xl border border-[#118778]/15 bg-[#f7f6ff] shadow-[0_28px_80px_rgba(70,65,130,0.12)] lg:grid-cols-[0.85fr_1.15fr]">
            ...
            <div className="border-b border-white/10 bg-[linear-gradient(145deg,rgba(17,135,120,0.09),transparent_52%)] p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-9">
              ...
              <div className="mt-5 flex flex-wrap items-end gap-x-3 gap-y-2">
                <strong className="pricing-plan-price text-[clamp(2.4rem,5vw,4rem)] font-semibold leading-none tracking-[-0.05em] text-white">₹6.76–₹11.58</strong>
            ...
            <div className="p-6 sm:p-8 lg:p-9">
              ...
              <div className="mt-8 border-t border-white/10 pt-6">
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-white/50">
                  Every completed call includes its duration, services used, and final cost in your dashboard. All customer-facing prices are shown in INR. Taxes are excluded.
                </p>
              </div>
            </div>
          </article>
          ...
          <div className="pricing-calculator-card grid overflow-hidden rounded-3xl border border-white/10 bg-[#07100e] shadow-[0_28px_80px_rgba(0,0,0,0.28)] lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="pricing-estimate-panel flex flex-col justify-between bg-[linear-gradient(145deg,rgba(17,135,120,0.10),rgba(255,255,255,1)_55%)] p-6 sm:p-8 lg:p-9">
              ...
              <dl className="mt-10 divide-y divide-white/10 border-y border-white/10 text-sm">
                ...
                <div className="flex justify-between gap-5 py-4"><dt className="text-white/50">Estimated rate</dt><dd className="font-semibold text-white">₹6.76–₹11.58/min</dd></div>
              </dl>
