        ...
        <section className="bg-white px-5 pb-20 pt-28 sm:px-8 sm:pt-32 lg:px-12 lg:pb-24">
          <div className="mx-auto max-w-[1240px]">
            <div className="max-w-[760px]">
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#118778]">
                Deployment stories
              </p>
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-3">
              {caseStudies.map((study) => (
                <article
                  className="case-study-card group flex h-full flex-col overflow-hidden rounded-2xl border border-black/[0.08] bg-white shadow-[0_15px_50px_rgba(20,30,60,0.07)] transition duration-300 hover:border-[#118778]/25"
                  key={study.industry}
                  style={{
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <div className="mt-auto grid grid-cols-3 gap-2 pt-5">
                      {study.outcomes.map((outcome) => (
                        <div
                          className="rounded-lg border border-black/[0.07] bg-[#fafbfe] p-2.5 transition hover:border-[#118778]/25 hover:bg-[#f6f8ff]"
                          key={outcome.label}
                        >
                          <p
            ...
            <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {measurementPrinciples.map((principle) => (
                  <article
                    className="group rounded-2xl border border-black/[0.08] bg-white p-6 shadow-[0_8px_30px_rgba(20,30,60,0.04)] transition duration-300 hover:border-[#118778]/25 hover:bg-[#fafbff] hover:shadow-[0_12px_35px_rgba(17,135,120,0.08)]"
                    key={principle.number}
                  >
                    <p className="font-mono text-xs font-bold text-[#118778]">
                      {principle.number}
                    </p>
