              ...
              return (
                ...
                >
                  <div className="p-5">
                    ...
                    {"flow" in item ? (
                      <p className="mt-2 text-xs font-semibold text-[#123d35]">
                        {item.flow}
                      </p>
                    ) : null}
                    {provider.connected ? (
                    ...
                    {provider.id === "digitalbot" ? (
                      <div className="mt-4 rounded-xl border border-[#dfe7e4] bg-[#edf7f4]/60 p-3 text-xs leading-5 text-slate-700">
