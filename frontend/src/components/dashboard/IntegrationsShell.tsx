...
const catalog = {
  ...
  digitalbot: {
    ...
    color: "from-[#108D82] to-emerald-400",
      ...
      <section className="min-w-0 p-4">
        <div className="mx-auto grid max-w-[1500px] gap-6">
          <header className="border-b border-[#e1e2ef] bg-white pb-4">
            <div>
              <span className="text-xs font-semibold uppercase tracking-[0.18em] text-[#108D82]">Native connections</span>
          ...
          {notice ? <div className="rounded-xl border border-indigo-200 bg-indigo-50 px-4 py-3 text-sm text-[#108D82]">{notice}</div> : null}
              ...
              return (
                <article className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm" key={displayId}>
                  <div className="p-5">
                    ...
                    {"flow" in item ? <p className="mt-2 text-xs font-semibold text-[#108D82]">{item.flow}</p> : null}
