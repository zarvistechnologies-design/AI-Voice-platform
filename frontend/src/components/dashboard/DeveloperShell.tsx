...
const controlClass =
  "h-11 rounded-xl border border-[#dfe1ed] bg-white px-3.5 text-sm font-medium text-[#272936] outline-none transition placeholder:text-[#9699aa] focus:border-[#6468ff] focus:ring-3 focus:ring-[#6468ff]/10";
const primaryButtonClass =
  "inline-flex h-10 items-center justify-center rounded-xl bg-[#6468ff] px-4 text-sm font-semibold text-white transition hover:bg-[#626bc0] disabled:cursor-not-allowed disabled:opacity-50";
const secondaryButtonClass =
  "inline-flex h-10 items-center justify-center rounded-xl border border-[#dfe1ed] bg-white px-3.5 text-sm font-semibold text-[#3d4050] transition hover:border-[#bfc3e5] hover:bg-[#fbfbff]";
...
function EndpointRow({
  ...
  const methodClass = "bg-[#eff0ff] text-[#5057e5]";
  return (
...
export function DeveloperShell() {
  ...
  return (
    <main
      className={`grid min-h-screen bg-[#fbfbff] text-[#111113] ${
        showUserSidebar
    ...
    >
      ...
      <section className="min-w-0">
        <DashboardPageHeader
          ...
          actions={
            <>
              <div className="flex h-10 min-w-0 items-center overflow-hidden rounded-xl border border-[#dfe1ed] bg-[#fbfbff]">
                <code className="max-w-52 truncate px-3 text-xs font-semibold text-[#51556a]">
                  {baseUrl}
                </code>
                <button
                  className="h-full shrink-0 border-l border-[#dfe1ed] bg-white px-3 text-xs font-bold text-[#5057e5] transition hover:bg-[#eff0ff]"
                  type="button"
            ...
            {(
              ...
              <button
                className={`min-w-0 rounded-xl px-3 py-2.5 text-left transition ${
                  activeView === value
                    ? "bg-[#eff0ff] text-[#454bd3] shadow-sm"
                    : "text-[#6b6f80] hover:bg-[#fbfbff] hover:text-[#272936]"
                }`}
                key={value}
                type="button"
              ...
              >
                <span className="flex items-center gap-2 text-sm font-semibold">
                  <span className="grid size-6 shrink-0 place-items-center rounded-lg bg-white/80 text-[10px] text-[#6468ff]">
                    0{index + 1}
                  </span>
                  {label}
                </span>
              ...
              {activeView === "overview" ? (
                <section className={panelClass}>
                  <div className="flex flex-col gap-3 border-b border-[#dce3ea] px-5 py-5 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                      <span className="text-xs font-bold uppercase text-[#5057e5]">
                        Connection map
                      </span>
                  ...
                  <div className="grid border-b border-[#dce3ea] sm:grid-cols-4">
                    {[
                      ...
                      ["02", "Create call", "POST outbound", "#6468ff"],
                      [
                        "03",
                        "Receive event",
                  ...
                  <div className="grid lg:grid-cols-[minmax(0,1fr)_270px]">
                    <div className="border-b border-[#dce3ea] p-5 lg:border-b-0 lg:border-r">
                      <div className="mb-4 flex items-center justify-between gap-3">
                        ...
                        <span className="rounded-lg bg-[#eff0ff] px-2.5 py-1 text-xs font-bold text-[#5057e5]">
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        {includedFields.map((item) => (
                          <code
                            className="rounded-lg border border-[#dedee8] bg-[#fbfbff] px-2.5 py-1.5 text-[11px] font-semibold text-[#51556a]"
                            key={item}
                          >
                            {item}
                          </code>
                      ...
                      <button
                        className="mt-5 text-sm font-semibold text-[#5057e5] hover:text-[#444da4]"
                        type="button"
                  ...
                  <div className="border-b border-[#dce3ea] bg-[#f8fafc] p-5">
                    ...
                    <div className="mt-4 grid gap-2 sm:grid-cols-2">
                      {scopeCatalog.map((scope) => (
                        <label
                          className={`flex cursor-pointer items-center gap-3 rounded-xl border px-3 py-2.5 text-sm font-semibold transition ${keyScopes.includes(scope) ? "border-[#c4c8ec] bg-[#eff0ff] text-[#454bd3]" : "border-[#dfe1ed] bg-white text-[#5f6374] hover:bg-[#fbfbff]"}`}
                          key={scope}
                        >
                          <input
                  ...
                  <div className="border-b border-[#dce3ea] bg-[#f8fafc] p-5">
                    ...
                    <div className="mt-4 grid gap-2 sm:grid-cols-2">
                      {eventCatalog.map((event) => (
                        <label
                          className={`flex cursor-pointer items-center gap-3 rounded-xl border px-3 py-2.5 text-sm font-semibold transition ${webhookEvents.includes(event) ? "border-[#c4c8ec] bg-[#eff0ff] text-[#454bd3]" : "border-[#dfe1ed] bg-white text-[#5f6374] hover:bg-[#fbfbff]"}`}
                          key={event}
                        >
                          <input
            ...
            <aside className="min-w-0 self-start overflow-hidden rounded-2xl bg-[#111827] text-white shadow-[0_18px_48px_rgba(15,23,42,0.16)] 2xl:sticky 2xl:top-5">
              ...
              <div className="grid grid-cols-3 border-b border-white/10 bg-[#0b1220] p-1.5">
                {(["request", "response", "webhook"] as const).map((view) => (
                  <button
                    className={`h-8 rounded-lg text-xs font-semibold capitalize transition ${inspectorView === view ? "bg-[#6468ff] text-white" : "text-[#aeb6c7] hover:text-white"}`}
                    key={view}
                    type="button"
      ...
      {notice ? (
        <div
          ...
          aria-live="polite"
        >
          <span className="bg-[#6468ff]" aria-hidden="true" />
