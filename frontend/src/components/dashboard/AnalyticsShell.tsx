          ...
          <section className="hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[820px] text-left">
                <thead className="bg-[#fafaff] text-[10px] uppercase tracking-[.15em] text-[#777b8e]">
                  <tr>
                ...
                <tbody className="divide-y divide-[#ececf3]">
                  {fleetAgents.length ? (
                      ...
                      return (
                        ...
                        >
                          <td className="px-5 py-3.5">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <span className="mt-0.5 block text-xs text-[#8a8da0]">
                                  {agent.team}
                                </span>
                              </div>
                            </div>
                          ...
                          <td className="px-5 py-3.5">
                            ...
                            <span className="ml-1 text-xs text-[#8a8da0]">
                              calls
                            </span>
                          </td>
                          <td className="px-5 py-3.5">
                    ...
                    <tr>
                      <td
                        className="px-5 py-10 text-center text-sm text-[#8a8da0]"
                        colSpan={6}
                      >
