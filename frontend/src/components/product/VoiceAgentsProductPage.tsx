...
export function VoiceAgentsProductPage() {
  return (
    <SiteLayout>
      <div className="voice-build-page overflow-hidden bg-white text-[#14231f]">
          ...
          <div className="relative mx-auto max-w-[1380px]">
            ...
            <div className="voice-hero-grid grid min-w-0 items-center gap-14 xl:grid-cols-[minmax(0,0.98fr)_minmax(510px,0.82fr)] xl:gap-20">
              <div className="voice-hero-copy min-w-0 max-w-[760px]">
                ...
                <h1 className="mt-7 text-[clamp(2rem,2.55vw,2.65rem)] leading-[1.03] font-semibold tracking-[-0.05em]">
        ...
        <section className="relative border-t border-white/[0.06] bg-white px-[clamp(1.25rem,5vw,4.75rem)] py-20 sm:py-24 lg:py-28">
          ...
          <div className="relative mx-auto max-w-[1380px]">
            <div className="grid gap-6 lg:grid-cols-[minmax(210px,0.38fr)_minmax(0,1fr)] lg:gap-16">
              ...
              <div className="max-w-[880px]">
                <h2 className="text-[clamp(1.8rem,2.5vw,2.55rem)] leading-[1.1] font-semibold tracking-[-0.04em]">
                  The three foundations of every voice agent.
                </h2>
                <p className="mt-5 max-w-[760px] text-[15px] leading-7 text-white/52 sm:text-base sm:leading-8">
                  Define how your agent speaks, the information it can use, and the actions it can complete. Each foundation stays clear, controlled, and easy to update.
                </p>
              </div>
            </div>
        ...
        <section className="relative bg-white px-[clamp(1.25rem,5vw,4.75rem)] py-24 sm:py-28 lg:py-32">
          
          <div className="relative mx-auto max-w-[1380px]">
            <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-end">
              <div>
                <Eyebrow>How you build it</Eyebrow>
                <h2 className="mt-5 max-w-[640px] text-[clamp(1.9rem,2.7vw,2.8rem)] leading-[1.08] font-semibold tracking-[-0.045em]">
                  From first setup to a live agent in six clear steps.
                </h2>
              </div>
              <p className="max-w-[650px] text-base leading-8 text-white/54 lg:justify-self-end">
                Move from agent identity to deployment with a guided workflow. Your operations, support, and technical teams can each own the parts that match their role.
              </p>
            </div>
        ...
        <section className="relative border-y border-white/[0.06] bg-white px-[clamp(1.25rem,5vw,4.75rem)] py-24 sm:py-28 lg:py-32">
          ...
          <div className="relative mx-auto grid max-w-[1380px] gap-14 lg:grid-cols-[minmax(300px,0.72fr)_minmax(0,1.28fr)] lg:gap-20">
            <div>
              <div className="lg:sticky lg:top-32">
                ...
                <h2 className="mt-5 max-w-[560px] text-[clamp(1.9rem,2.7vw,2.8rem)] leading-[1.08] font-semibold tracking-[-0.045em]">
                  Configure every part of the customer experience.
                </h2>
                <p className="mt-6 max-w-[480px] text-base leading-8 text-white/52">
                  Set voice, knowledge, integrations, routing, and permissions in one place while keeping every interaction governed by your team.
                </p>
          ...
          <div className="relative mx-auto grid max-w-[1380px] gap-14 lg:grid-cols-[0.72fr_1.28fr] lg:gap-24">
            <div>
              <Eyebrow>F.A.Q.</Eyebrow>
                <h2 className="mt-5 max-w-[620px] text-[clamp(1.9rem,2.7vw,2.8rem)] leading-[1.08] font-semibold tracking-[-0.045em]">
        ...
        <section className="px-[clamp(1.25rem,5vw,4.75rem)] py-20 sm:py-24" id="team-contact">
          <div className="mx-auto flex max-w-[1380px] flex-col gap-8 border-t border-white/10 pt-14 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-[820px]">
              ...
              <h2 className="mt-4 text-[clamp(1.8rem,2.6vw,2.65rem)] leading-[1.1] font-semibold tracking-[-0.04em]">
                Plan a voice agent around your team&apos;s workflow. <span className="text-white/42">We&apos;ll help you map the rollout.</span>
              </h2>
            </div>
        ...
        <style>{`
          ...
          /* Keep this product experience light without affecting shared product pages. */
          .voice-build-page > section:not(:first-child) [class*="text-white"] {
            color: #14231f !important;
          }

          .voice-hero-copy,
          .voice-hero-copy [class*="text-white"] {
            color: #14231f !important;
          }

          .voice-build-page [class*="border-white"] {
            border-color: rgba(20, 35, 31, 0.12) !important;
          }

          .voice-build-page > section:nth-of-type(4) [class*="bg-[#08111e]"] {
            background: #ffffff !important;
            box-shadow: 0 18px 48px rgba(20, 35, 31, 0.08);
          }

          .voice-build-page > section > div > h2,
          .voice-build-page h2 {
          ...
          .voice-build-page .voice-hero-copy h1 {
